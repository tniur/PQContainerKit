...
public extension PQContainerKit {
    ...
    enum MLKEM768 {
        ...
        public struct PublicKey: Hashable, Sendable {
            ...
            /// - Throws: `PQContainerKit.Error.invalidKeyRepresentation`
            ...
            public init(rawRepresentation: Data) throws {
                do {
                    ...
                    throw PQContainerKit.Error.invalidKeyRepresentation
                }
            }
            ...
            /// - Throws: `PQContainerKit.Error.invalidBase64` if Base64 decoding fails,
            ///           or `PQContainerKit.Error.invalidKeyRepresentation` if decoded bytes are not a valid key.
        ...
        /// - Throws: `PQContainerKit.Error.keyGenerationFailed` if platform key generation fails.
