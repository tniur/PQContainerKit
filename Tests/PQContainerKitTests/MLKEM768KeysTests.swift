...
struct MLKEM768KeysTests {
    ...
    func publicKeyBase64RoundTrip() throws {
        ...
        let imported = try PQContainerKit.MLKEM768.PublicKey(base64: exported)
    ...
    func invalidBase64Throws() {
        #expect(throws: PQContainerKit.Error.invalidBase64) {
            _ = try PQContainerKit.MLKEM768.PublicKey(base64: "not base64!!!")
        }
    }
    ...
    func validBase64ButInvalidKeyBytes() {
        do {
            _ = try PQContainerKit.MLKEM768.PublicKey(base64: "AA==")
